...
public class RingtonePlayingService_1 extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        String state = intent.getExtras().getString("extra01");
...
//----------------------------------------------------------------------提示
            ...
            Intent intent_main_activity = new Intent(this.getApplicationContext(), calendarMain.class);
