...
public class Alarm_Receiver_4 extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        timePicker_4.media_song = MediaPlayer.create(context,R.raw.alarm);
...
//----------------------------------------------------------------------提示
            ...
            Intent intent_main_activity = new Intent(context, timePicker_4.class);
